...
console.log("NOW WE ACCESS TO INDEX1.JS <EXPORTS> TO SHOW THEM:");

//We create a variable called "info" to acquire it exported elements
const info = require('./index1.js');
console.log(info.first_thing);
console.log(info.second_thing);


//This is how we can actually run the "exports" function created in "index1.js"
info.MySuperFunction();


//Finally, this is how the whole "exports" obtained from the "index1.js" file looks like:
